...
import { priorities, statuses } from "@/app/(workspace)/tasks/[taskid]/data";
...
const initialData: Matter[] = [
  ...
  {
    id: 2,
    name: "Property Conveyance – Title Search",
    eventType: "Research",
    status: "inprogress",
    priority: "medium",
    dueDate: "2025-01-22",
  ...
  {
    id: 3,
    name: "Client Intake – Wilson Estate",
  ...
  {
    id: 5,
    name: "Court Appearance – Traffic Matter",
    eventType: "Hearing",
    status: "complete",
    priority: "high",
    dueDate: "2025-01-10",
  ...
  {
    id: 6,
    name: "Draft Lease Agreement – Commercial Property",
    eventType: "Drafting",
    status: "not started",
    priority: "low",
    dueDate: "2025-01-28",
  ...
  {
    id: 8,
    name: "Evidence Compilation – Insurance Claim",
  ...
  },
  {
    ...
    cell: ({ row, table }) => {
      ...
      return (
        ...
        <UserGroup className={"bg-blue-100 outline-blue-500" }/>
      );
    },
  },
  { 
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem
              onClick={() => table.options.meta?.toggleRowEditing(row.id)}
            >
              {isEditing ? "Finish Editing" : "Edit Row"}
            </DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem>
              <Link href={"/tasks/" + $id + "/spreadsheet"} replace>
                Open matter
              </Link>
            </DropdownMenuItem>
...
export function MatterDataTable() {
