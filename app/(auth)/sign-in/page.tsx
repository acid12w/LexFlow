      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center">
        ...
        <div className="mt-4 flex gap-4 flex-col w-[70%] md:w-1/2 text-center">
          <aside className="flex justify-center items-center gap-2">
            ...
            <p className="text-sm text-gray-500 dark:text-white flex-none">Use your own email or</p>
            <span className="bg-border shrink w-24 h-px"></span>
          </aside>
          <div className="flex justify-between gap-2">
            <Button variant={"outline"} className="w-[45%]"><FcGoogle /> Google</Button>
            <Button variant={"outline"} className="w-[45%]"><PiMicrosoftOutlookLogoFill className="fill-[#0072C6]" /> outlook</Button>
          </div>
           <aside>
            <p className="text-sm text-gray-500">Dont have a account ? Singnup</p>
          </aside>
        </div>
      </div>
        ...
        <div className="bg-[#0974FF] pt-4 pb-16 px-4 h-[92vh] flex flex-col justify-between rounded-xl">
          ...
          <div className="flex flex-col items-center gap-15">
            ...
            <div className="text-center ">
              ...
              <p className="text-blue-100 px-4">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum .</p>
            </div>
          </div>
        </div>
      </div>
